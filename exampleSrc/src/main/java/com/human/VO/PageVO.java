...
// perPageNum, page, totalCount  3개의 정보만 있으면 pageVO 객체의 모든 변수를 계산할 수 있다.
public class PageVO {
	private int startNo;//게시판테이블,회원테이블의 필드와는 직접관계없음.  //   이 변수는 쿼리문에 활용
	private int perPageNum;  // V                            //   이 변수는 쿼리문에 활용
	                                        // select * from bbs ~~~~~  where between startNO and pa
	private Integer page;//   jsp단에서 null로 값이 올때 에러가 발생하지 않도록 Integer사용  V
